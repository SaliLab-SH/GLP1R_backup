# This script is from RNAPII imp_tutorial
...
num_clusters = 2
num_top_models = 50
merge_directories = ["../Sampling_05/new_output_003/"]
prefiltervalue = 3500.0
