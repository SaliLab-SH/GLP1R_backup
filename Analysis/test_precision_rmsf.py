...
'''test_precision_rmsf.py
This script is from RNAP imp tutorial.
...
root_cluster_directory = glob.glob('kmeans_*_*')[0] # specify the directory (of clusters) to be analysed
...
selections={"GLP1RA":["GLP1RA"],
            "GLP1RB":["GLP1RB"],
            "GLP1RA_GLP1RB":["GLP1RA","GLP1RB"]}
